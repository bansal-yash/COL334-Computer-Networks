...
def run():
    ...
    for DELAY in delay_list:
        for i in range(0, NUM_ITERATIONS):
            cleanup_files("1received_file.txt")
            cleanup_files("2received_file.txt")
            ...
            c1_cmd = f"python3 p2_client.py {SERVER_IP1} {SERVER_PORT1} --pref_outfile 1 &"
            c2_cmd = f"python3 p2_client.py {SERVER_IP2} {SERVER_PORT2} --pref_outfile 2 &"
